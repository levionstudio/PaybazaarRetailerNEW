              ...
              <div class="beneficiary-details">
                ...
                <div class="bene-content">
                  <div class="bene-grid">
                    ...
                    <span class="bene-value">: ${data.status.toUpperCase()}</span>
              ...
              <tbody>
                <tr style="height: 70px;">
                  ...
                  <td style="vertical-align: top;">
                    DTH Recharge ${data.status.toUpperCase()}.<br/>
                    ID: ${data.dth_transaction_id}
                  </td>
                  ...
                  <tbody>
                    <tr style={{ height: '70px' }}>
                      ...
                      <td className="border-r border-black p-3 align-top">
                        DTH Recharge SUCCESS.<br/>
                        ID: {selectedTransaction.dth_transaction_id}
                      </td>
