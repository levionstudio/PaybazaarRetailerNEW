...
// ─────────────────────────────────────────────────────────────────────────────
const writeReceiptToTab = (tab: Window, data: DTHReceiptData, retailerProfile: any) => {
...
<head>
  ...
  <title>DTH Recharge Receipt - ${data.customerId}</title>
  <style>
  ...
  <div class="receipt-container">
    ...
    <div class="details-grid">
      ...
      <div class="detail-item">
        ...
        <div class="value">DTH Recharge</div>
      </div>
      <div class="detail-item">
...
const DTHRecharge = () => {
  ...
  // No auto-open, handled by success animation button now (if we add one)
  // Actually, I'll update the Success Animation component itself.
