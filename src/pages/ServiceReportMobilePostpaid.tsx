            ...
            <div class="details-row">
              ...
              <div class="beneficiary-details">
                ...
                <div class="bene-content">
                  <div class="bene-grid">
                    <span class="bene-label">Mobile Number</span>
                    <span class="bene-value">: ${data.mobile_number}</span>
                    
                    <span class="bene-label">Operator</span>
                    <span class="bene-value">: ${data.operator_name.toUpperCase()}</span>
                    
                    <span class="bene-label">Circle</span>
                    <span class="bene-value">: ${data.circle_name.toUpperCase()}</span>
                    
                    <span class="bene-label">Status</span>
                    <span class="bene-value">: ${data.recharge_status.toUpperCase()}</span>
                    
                    <span class="bene-label">Date Time</span>
                    <span class="bene-value">: ${formatDate(data.created_at)}</span>
                  </div>
                </div>
              </div>
            </div>
              ...
              <tbody>
                <tr style="height: 70px;">
                  ...
                  <td style="vertical-align: top;">
                    Postpaid Bill Payment SUCCESS.<br/>
                    ID: ${data.postpaid_recharge_transaction_id}<br/>
                    ID: ${data.order_id || '-'}
                  </td>
                  ...
                  <tbody>
                    <tr style={{ height: '70px' }}>
                      ...
                      <td className="border-r border-black p-3 align-top">
                        Postpaid Bill Payment SUCCESS.<br/>
                        ID: {selectedTransaction.postpaid_recharge_transaction_id}
                      </td>
